# Generated by Powerlevel10k configuration wizard on 2022-10-01 at 13:32 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 59558.
# Wizard options: compatible, unicode, lean, 12h time, 2 lines, disconnected, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=014
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%112F'   # green foreground
